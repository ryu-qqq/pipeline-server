...
> **포트 충돌 주의**: MySQL(3306), MongoDB(27017), Redis(6379), FastAPI(8000) 포트를 사용합니다. 로컬에서 동일 포트를 점유하는 프로세스가 있으면 먼저 종료해 주세요.
...
| 5. 설계 결정 기록 | [`docs/adr/`](docs/adr/) | 주요 기술 선택의 대안 비교와 채택 근거 (ADR 3건) |
| 6. 테스트 전략 | [`docs/testing-strategy.md`](docs/testing-strategy.md) | 테스트 피라미드, 레이어별 전략, 커버리지 분석 |
